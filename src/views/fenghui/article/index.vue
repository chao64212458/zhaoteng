...
let image = ''
const defaultForm = { articleId: null, title: null, introduction: '', content: '', thumbnail: null, topFlg: 0, updateUser: null, updateTime: null, tips: null, createUser: null, createTime: null, articleType: 0, articleDate: null, articleFrom: null }
export default {
  name: 'Article',
  ...
  cruds() {
    return CRUD({ title: '文章', url: 'api/article', idField: 'articleId', sort: 'articleId,desc', crudMethod: { ...crudTArticle }})
  },
  data() {
    return {
      show: false,
