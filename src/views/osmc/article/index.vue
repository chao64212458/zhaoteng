<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <!--表单组件-->
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" @opened="onDialogOpen" :title="crud.status.title" width="1280px">
...
let image = ''
const defaultForm = { articleId: null, title: null, introduction: '', content: '', thumbnail: null,linkUrl:'', topFlg: 0, updateUser: null, updateTime: null, tips: null, createUser: null, createTime: null, articleType: 0, articleDate: null, articleFrom: null }
export default {
  name: 'Article',
  ...
  cruds() {
    return CRUD({ title: '文章', url: 'api/osmc/article', idField: 'articleId', sort: 'articleId,desc', crudMethod: { ...crudTArticle }})
  },
  data() {
    return {
      show: false,
